...
WebUI.verifyElementVisible(findTestObject('Program/Page_Programs/p_core.country.is.required'))

//WebUI.verifyElementVisible(findTestObject('Program/Page_Programs/p_core.english.name.required'))
//
//WebUI.verifyElementVisible(findTestObject('Program/Page_Programs/p_core.program.type.is.required'))
//
//WebUI.verifyElementVisible(findTestObject('Program/Page_Programs/p_core.country.is.required'))
WebUI.closeBrowser()
