...
WebUI.click(findTestObject('Program/Page_Programs/ThreeDotsFromProgram'))

WebUI.click(findTestObject('Program/Page_Programs/Delete_Button'))

WebUI.click(findTestObject('Program/Page_Programs/Yes Delete'))
